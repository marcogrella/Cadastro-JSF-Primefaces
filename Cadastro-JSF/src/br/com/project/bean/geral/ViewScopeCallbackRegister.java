...
/* Todo o managed ben que for criado e destruído passará por essa classe 
 * Essa classe será registrada pelo Facesconfig
 * */
...
public class ViewScopeCallbackRegister implements ViewMapListener {
	...
	/* configuração criação e destruição de evento */
	@Override
