...
/* Essa classe possui o intuito de instanciar um objeto para ler os 
 * acessos (permissão) além de integrar as anotações da interface 
 * annottation.
 * OBS: adota o comprator porque precisa ver qual é a ordem dos 
 * dos atributos (principal, consulta ou descrição)    */
...
public class ObjetoCampoConsulta implements Serializable, Comparator<ObjetoCampoConsulta>{
	...
	/* método para retornar os objetos de forma ordenada. */
	@Override
